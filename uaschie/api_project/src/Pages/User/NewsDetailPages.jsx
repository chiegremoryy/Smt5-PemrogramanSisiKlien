...
const NewsDetailPages = () => {
      ...
      axios
        ...
        .then((response) => {
          if (response.data.status) {
            setComments([
              ...comments,
              { comment_text: newComment, created_at: new Date().toISOString() },
            ]);
            setNewComment("");
          }
        })
  ...
  return (
    <div className="p-6 bg-gray-100 flex-1 w-full max-w-full pt-20" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div>
            <div className="bg-gray-100 rounded-lg p-6">
              ...
              <div className="mt-8 space-y-4">
                <p><strong>Pengamatan Visual:</strong> {report.pengamatan_visual}</p>
                <p><strong>Gempa Visual:</strong> {report.gempa_visual}</p>
                <p><strong>Klimatologi Visual:</strong> {report.klimatologi_visual}</p>
                <p className="mt-4 text-sm text-gray-500">
                  Laporan oleh: <a href={report.detail_url} target="_blank" rel="noopener noreferrer">{report.report_by}</a>
                </p>
              </div>
            </div>
          </div>
